  ...
  return (
    <div className='px-24 py-24'>
      <div className='bg-white rounded-10 px-24 py-24'>
        <div className='mb-24'>
          <h4 className='fw-semibold text-neutral-500 text-20 mb-4'>{isEdit ? "Edit User" : "Create User"}</h4>
          <p className='text-14 text-neutral-400 mb-0'>{isEdit ? "Update name, contact and role." : "Create an active user account."}</p>
        </div>
        ...
        {isLoading ? (
          ...
          <form className='row gy-4' onSubmit={handleSubmit}>
            ...
            <div className='col-md-6'>
              <label className='text-14 text-neutral-500 fw-medium mb-8'>Role</label>
            ...
            <div className='col-12 d-flex align-items-center gap-12 mt-24'>
              ...
              <button type='button' className='px-18 py-10 border border-neutral-40 rounded-pill text-14 text-neutral-500 bg-white' onClick={() => router.push("/admin/users")}>Cancel</button>
            </div>
          </form>
        )}
      </div>
