      ...
      <div className='bg-white rounded-10 px-24 py-24'>
        <div className='d-flex flex-wrap align-items-center justify-content-between gap-16 mb-24'>
          <div>
            ...
            <p className='text-14 text-neutral-400 mb-0'>
              Review all customer subscriptions and their entitlement periods.
            </p>
          </div>
          <AdminRefreshButton
            isLoading={isLoading}
        ...
        <form className='row gy-3 align-items-end mb-24' onSubmit={applyFilters}>
          ...
          <div className='col-xl-2 col-md-4'>
            <label className='text-14 text-neutral-500 fw-medium mb-8'>Plan ID</label>
            <input
              type='number'
              min='1'
              className='common-input rounded-pill'
        ...
        <div className='table-responsive admin-users-table'>
          <table className='table mb-0'>
            <thead>
              <tr>
                <th className='text-12 fw-medium text-neutral-500 py-16 px-20'>Subscription</th>
            ...
            <tbody>
              {isLoading ? (
                <tr>
                  <td className='py-20 px-20 text-neutral-400' colSpan='7'>Loading subscriptions...</td>
                </tr>
                ...
                subscriptions.map((subscription) => (
                  <tr key={subscription.id}>
                    ...
                    <td className='py-16 px-20'>
                      ...
                      <span className='text-12 text-neutral-400'>ID: {subscription.planId || "-"}</span>
                    </td>
                    <td className='py-16 px-20'>
                ...
                <tr>
                  <td className='py-24 px-20 text-neutral-400' colSpan='7'>No subscriptions found.</td>
                </tr>
              )}
            </tbody>
          </table>
